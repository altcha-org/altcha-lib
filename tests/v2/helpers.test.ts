...
import * as helpers from '../../src/v2/helpers.js';
...
describe('helpers', () => {
	...
	describe('hash()', () => {
		test('should return a SHA-256 as buffer', async () => {
			expect(
				helpers.bufferToHex(await helpers.hash('SHA-256', 'Hello World'))
			).toEqual(
