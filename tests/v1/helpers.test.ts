...
describe('helpers', () => {
	...
	describe('hashHex()', () => {
		it('should return SHA-1 hash', async () => {
			expect(await hashHex('SHA-1', 'hello world')).toEqual(
				'2aae6c35c94fcfb415dbe95f408b9ce91ee846ed'
			);
		});

		it('should return SHA-256 hash', async () => {
			expect(await hashHex('SHA-256', 'hello world')).toEqual(
				'b94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde9'
			);
		});

		it('should return SHA-512 hash', async () => {
			expect(await hashHex('SHA-512', 'hello world')).toEqual(
