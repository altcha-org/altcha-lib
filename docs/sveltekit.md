...
* Sets `event.locals.altcha: AltchaResult`, which includes the challenge data and verification result.
...
File: `src/routes/altcha/verify/+server.ts`
...
### 4a. Protect a route handler with verifyEvent
